...
StubbyConfig = {
	["addinfo"] = {
		...
		["Enchantrix"] = "Enchantrix|Display information in item tooltips pertaining to disenchanting, prospecting, and milling results.  [7.7.6000] This AddOn is licensed under the GNU GPL, see GPL.txt for details.",
	},
	["inspected"] = {
		["Informant"] = true,
		["Enchantrix"] = true,
